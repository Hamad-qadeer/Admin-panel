                ...
                <Card>
                    <CardHeader>
                        <div className="d-flex justify-content-between">
                            <div>
                                <Link href="/AddKYCUser">
                                    <button className="btn btn-info me-2" type="button"> Create new KYC User</button>
                                </Link>
...
export default KYCUserListComponent;