                ...
                <Card>
                    <CardHeader>
                        <div className="d-flex justify-content-between">
                            <div>
                                <Link href="/AddPool">
                                    <button className="btn btn-info" type="button"> Create New Pool</button>
                                </Link>
                            </div>
                                    ...
                                    <Tbody>
                                        {tabledata.map((rowData: any, index: any) => (
                                            <Tr key={index}>
                                                ...
                                                <Td>{rowData.low}</Td>
                                                <Td> <FeatherIcon icon="more-vertical"/> </Td>
                                            </Tr>
                                        ))}
                                    </Tbody>
                                </Table>
...
export default ListPoolComponent;